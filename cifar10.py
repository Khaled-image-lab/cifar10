########################################################################
#
#Fonction pour telecharger CIFAR-10  a partir d'internet et de l'enregistrer
# 
#
...
def load_training_data():
    ...
    images = np.zeros(shape=[50000, img_size, img_size, num_channels], dtype=np.float32)
    cls = np.zeros(shape=[50000], dtype=np.int8)
